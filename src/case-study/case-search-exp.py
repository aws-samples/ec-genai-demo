...
def main():
    st.title("生成AIによる検索体験向上 事例")
    st.markdown("""#### OZVISION""")
    image = Image.open("img/case-study/OZVISION.png")
    st.image(image, caption="", use_column_width=True)
    
    
    st.markdown("""#### Amazon""")
    image2 = Image.open("img/case-study/Amazon_rufus.png")
    st.image(image2, caption="", use_column_width=True)
    st.markdown("https://www.aboutamazon.com/news/retail/amazon-rufus")
